...
class ElnaVectorDB(Database):
    ...
    def upload_batch(self, embedding, documents, is_first_chunk, is_last_chunk, file_name=None):
        ...
        params = [
            ...
            {"type": Types.Vec(Types.Vec(Types.Float32)), "value": embeddings},  # Embeddings
            {"type": Types.Text, "value": file_name},
        ]
    ...
    def upload_batch_optimized(self, embedding, documents, session_id, file_name=None, chunk_index=0, total_chunks=1, total_files=1):
        ...
        params = [
            ...
            {"type": Types.Vec(Types.Text), "value": contents},  # documents: Vec<String>
            {"type": Types.Vec(Types.Vec(Types.Float32)), "value": embeddings},  # embeddings: Vec<Vec<f32>>
        ...
        self._logger.info(f"Processed chunk {chunk_index + 1}/{total_chunks} for file '{file_name}' in session {session_id} (total files: {total_files}): {result}")
        return result
